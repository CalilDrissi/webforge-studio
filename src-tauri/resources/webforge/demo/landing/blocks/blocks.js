Webforge.Blocks.add("contact-form/contact-form-1", {
    name: "Contact form 1",
    image: Webforge.themeBaseUrl + "/screenshots/blocks/contact-form/contact-form-1-thumb.webp",
...
});Webforge.Blocks.add("contact-form/contact-form-appointment", {
    name: "Contact form appointment",
    image: Webforge.themeBaseUrl + "/screenshots/blocks/contact-form/contact-form-appointment-thumb.webp",
...
});Webforge.Blocks.add("contact-form/contact-form-reservation", {
    name: "Contact form reservation",
    image: Webforge.themeBaseUrl + "/screenshots/blocks/contact-form/contact-form-reservation-thumb.webp",
    html: `<div data-v-component-plugin-contact-form-form data-v-storage="database" data-v-confirm-email="true" data-v-name="contact-form-appointment">
  ...
  <form action="" method="post">
	...
	Webforge.BlocksGroup['Contact form'] = ["contact-form/contact-form-1","contact-form/contact-form-appointment","contact-form/contact-form-reservation"];
Webforge.Blocks.add("post/post-1", {
    name: "Post 1",
    image: Webforge.themeBaseUrl + "/screenshots/blocks/post/post-1-thumb.webp",
...
});Webforge.Blocks.add("post/posts-1", {
    name: "Posts 1",
    image: Webforge.themeBaseUrl + "/screenshots/blocks/post/posts-1-thumb.webp",
  ...
  <div class="row">
	...
	Webforge.BlocksGroup['Post'] = ["post/post-1","post/posts-1"];
Webforge.Blocks.add("product/product-1", {
    name: "Product 1",
    image: Webforge.themeBaseUrl + "/screenshots/blocks/product/product-1-thumb.webp",
    ...
    <article class="single-product-wrapper">
      ...
      <div class="product-image">
        ...
        <div class="product-favourite">
          <a href="product/product.html" class="la la-heart" data-v-webforge-action="addToWishlist" data-v-product-add_wishlist_url>
            <span></span>
          </a>
        </div>
        ...
        <div class="product-compare">
          <a href="product/product.html" class="la la-random" data-v-webforge-action="addToCompare" data-v-product-add_compare_url>
            <span></span>
          </a>
        </div>
      ...
      <div class="product-content">
        ...
        <div class="hover-content" data-v-if="prod.price > 0 && !prod.has_variants">
          ...
          <div class="add-to-cart-btn">
            ...
            <a href="" class="btn btn-primary btn-sm w-100" data-v-if="prod.stock_quantity > 0" data-v-product-add_cart_url data-v-webforge-action="addToCart" data-product_id="1">
...
});Webforge.Blocks.add("product/products-1", {
    name: "Products 1",
    image: Webforge.themeBaseUrl + "/screenshots/blocks/product/products-1-thumb.webp",
  ...
  <div class="row">
	...
	Webforge.BlocksGroup['Product'] = ["product/product-1","product/products-1"];

	Webforge.BlocksGroup['Reusable'] = [""];
Webforge.Blocks.add("subscribe/notify-1", {
    name: "Notify 1",
    image: Webforge.themeBaseUrl + "/screenshots/blocks/subscribe/notify-1-thumb.webp",
  ...
  <form action="" method="post" data-v-webforge-action="submit" data-selector="[data-v-component-plugin-newsletter-form='']" data-v-webforge-on="submit">
    <input type="hidden" class="form-control" placeholder="First name" name="firstname-empty">
    <input type="hidden" class="form-control" placeholder="Email" name="csrf" data-v-csrf>
...
});Webforge.Blocks.add("subscribe/subscribe-1", {
    name: "Subscribe 1",
    image: Webforge.themeBaseUrl + "/screenshots/blocks/subscribe/subscribe-1-thumb.webp",
    html: `<div data-v-component-plugin-contact-form-form data-v-storage="database" data-v-confirm-email="true" data-v-name="contact-form-appointment">
  ...
  <form action="" method="post" data-v-webforge-action="submit" data-selector="[data-v-component-plugin-contact-form-form]" data-v-webforge-on="submit">
    <input type="hidden" class="form-control" placeholder="First name" name="firstname-empty">
    <input type="hidden" class="form-control" placeholder="Email" name="csrf" data-v-csrf>
	...
	Webforge.BlocksGroup['Subscribe'] = ["subscribe/notify-1","subscribe/subscribe-1"];
