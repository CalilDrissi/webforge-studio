...
_
		...
		onUpload(event) {
			...
			if (this.files && this.files[0]) {
				Webforge.MediaModal.showUploadLoading();
			...
			function imageIsLoaded(e) {
					...
					formData.append("mediaPath", Webforge.MediaModal.mediaPath + Webforge.MediaModal.currentPath);
					...
					.then((data) => {
						let fileElement = Webforge.MediaModal.addFile({
							name:data,
							type:"file",
							path: Webforge.MediaModal.currentPath + "/" + data,
							size:1
						},true);
						
						fileElement.scrollIntoView({behavior: "smooth", block: "center", inline: "center"});
						
						Webforge.MediaModal.hideUploadLoading();				
					})
					.catch((error) => {
