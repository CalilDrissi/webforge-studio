...
Webforge.Components.extend("_base", "_base", {
	 properties: [{
		...
		afterInit:function(node, inputElement) {
			let selector = Webforge.StyleManager.getSelectorForElement(node);
...
Webforge.Components.extend("_base", "_base", ComponentBaseTypography);
...
Webforge.Components.extend("_base", "_base", ComponentBaseSize);
...
Webforge.Components.extend("_base", "_base", ComponentBaseMargin);
...
Webforge.Components.extend("_base", "_base", ComponentBasePadding);
...
Webforge.Components.extend("_base", "_base", {
	 properties: [{
		...
		onChange: function(node, value) {
			...
			Webforge.StyleManager.setStyle(node, "background-image", 'url(' + value + ')');
...
Webforge.Components.extend("_base", "_base", ComponentDeviceVisibility);


Webforge.Components.add("config/bootstrap", {
	...
	beforeInit: function (node) {
		...
		let cssVars = Webforge.ColorPaletteManager.getAllCSSVariableNames(window.FrameDocument.styleSheets/*, ":root"*/);
				...
				properties.push({
					...
					onChange: function(node, value, input) {
						...
						if (this.data.type == "font") {
							...
							Webforge.FontsManager.addFont(option.dataset.provider, value, node[0]);
						}

						Webforge.StyleManager.setStyle(":root", this.data.selector, value);
