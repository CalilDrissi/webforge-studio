...
Webforge.ComponentsGroup['Server Components'] = ["components/products", "components/product", "components/categories", "components/manufacturers", "components/search", "components/user", "components/product_gallery", "components/cart", "components/checkout", "components/filters", "components/product", "components/slider"];


Webforge.Components.add("components/product", {
    name: "Product",
...
Webforge.Components.add("components/products", {
    name: "Products",
...
Webforge.Components.add("components/manufacturers", {
    name: "Manufacturers",
...
Webforge.Components.add("components/categories", {
    name: "Categories",
...
Webforge.Components.add("components/search", {
    name: "Search",
...
Webforge.Components.add("components/user", {
    name: "User",
...
Webforge.Components.add("components/product_gallery", {
...
Webforge.Components.add("components/cart", {
    name: "Cart",
...
Webforge.Components.add("components/checkout", {
    name: "Checkout",
...
Webforge.Components.add("components/filters", {
    name: "Filters",
...
Webforge.Components.add("components/slider", {
    name: "Slider",
