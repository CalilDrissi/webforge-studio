...
Webforge.ComponentsGroup['Bootstrap 5'] =
...
Webforge.Components.extend("html/link", "html/btn", {
    classes: ["btn"],
    nodes: null,
    name: "Button",
...
Webforge.Components.extend("_base", "html/card", {
    ...
    name: "Card",
    html: '<div class="card">\
		  <img class="card-img-top bg-body-secondary" src="' +  Webforge.baseUrl + 'icons/image.svg" alt="Card image cap">\
		  <div class="card-body">\
...
Webforge.Components.extend("_base", "html/gridcolumn", {
    name: "Grid Column",
...
Webforge.Components.extend("_base", "html/gridrow", {
    name: "Grid Row",
