...
Webforge.ComponentsGroup['Elements'] = [
/*sections */
"elements/font-icon",
"elements/carousel", 
"elements/gallery",
...
Webforge.Components.extend("_base","elements/figure", {
    nodes: ["figure"],
	name: "Figure",
    image: "icons/image.svg",
    resizable:true,
    html: `<figure>
		  <img src="${Webforge.baseUrl}icons/image.svg" alt="Trulli">
	...
	stylesheets:[{
			...
			'src': Webforge.baseUrl + 'css/figure.css',
	...
	javascripts:[
		{
			'src': Webforge.baseUrl + 'css/figure.js',
...
//Icon
Webforge.Components.extend("_base","elements/font-icon", {
    classes: ["la", "lab"],
    name: "Font Icon",
    ...
    properties: [
{
		...
		data: {
			url: Webforge.baseUrl + "../../resources/{value}.html",
			clickElement:"li",
			insertElement:"i",
			elements: 'Loading ...',
			options: [{
...
Webforge.Components.extend("_base","elements/svg-image", {
    nodes: ["svg"],
    name: "Svg Image",
    image: "icons/star.svg",
	...
	data: {
		url: Webforge.baseUrl + "../../resources/svg/icons/{value}/index.html",
		clickElement:"li",
		insertElement:"svg",
		elements: 'Loading ...',
		options: [{
...
Webforge.Components.add("elements/svg-element", {
...
//Gallery
Webforge.Components.add("elements/gallery", {
        ...
        onChange: function(node, value, input, component, event) {
			if (event.action) {
				if (event.action == "add") {
					...
					Webforge.Components.render("elements/gallery");
				}
...
//Tabs
Webforge.Components.add("elements/tab", {
...
Webforge.Components.add("elements/tabs", {
    attributes: ["data-component-tabs"],
    name: "Tabs",
    image: "icons/tabs.svg",
    html: `
			...
			onChange: function(node, value, input, component, event) {
				...
				if (event.action) {
					if (event.action == "add") {
						...
						//temporary solution to better update list
						Webforge.Components.render("elements/tabs");
					}
					...
					if (event.action == "remove") {
						...
						Webforge.Builder.iframe.contentWindow.bootstrap.Tab.getOrCreateInstance(tab).show();
					}
				}
...
//Accordion
Webforge.Components.add("elements/accordion", {
    classes: ["accordion"],
    name: "Accordeon",
			...
			onChange: function(node, value, input, component, event) {
				...
				if (event.action) {
					if (event.action == "add") {
						...
						//temporary solution to better update list
						Webforge.Components.render("elements/accordion");
					}
					...
					if (event.action == "remove") {
						...
						//el[0].click();
						//Webforge.Builder.iframe.contentWindow.bootstrap.Collapse.getOrCreateInstance(el[0]).toggle();
					}
				}
...
Webforge.Components.add("elements/flip-box", {
    classes: ["flip-box"],
    name: "Flip box",
...
Webforge.Components.add("elements/counter", {
    nodes: [".counter"],
    name: "Counter",
...
Webforge.Components.add("elements/testimonial", {
    nodes: [".counter"],
    name: "Testimonial",
...
Webforge.Components.add("elements/social-icons", {
			...
			onChange: function(node, value, input, component, event) {
				...
				if (event.action) {
					if (event.action == "add") {
						...
						//temporary solution to better update list
						Webforge.Components.render("elements/social-icons");
					}
					if (event.action == "remove") {
...
function carouselAfterDrop(node) {
	...
	body = Webforge.Builder.frameBody;
	...
	if (!body.querySelector("#swiper-js")) {
		...
		lib.addEventListener('load', function() {		
			Webforge.Builder.iframe.contentWindow.initSwiper();
		});
	} else {
		Webforge.Builder.iframe.contentWindow.initSwiper(true);
	}
	
	return node;
};

Webforge.Components.add("elements/carousel", {
    name: "Carousel",
    ...
    onChange: function (node, property, value) {
		...
		if (property.key == 'effect') {
			//Webforge.Builder.iframe.contentWindow.cleanSwiper(element);
        ...
        onChange: function(node, value, input, component, event) {
			...
			if (event.action) {
				if (event.action == "add") {
					...
					//temporary solution to better update list
					Webforge.Components.render("elements/carousel");
				}
				if (event.action == "remove") {
...
//Slider
Webforge.Components.add("elements/slider", {
	name: "Slider",
...
Webforge.Components.add("elements/icon-list", {
    nodes: [".counter"],
    name: "Icon list",
...
Webforge.Components.add("elements/divider", {
    nodes: [".counter"],
    name: "Divider",
    image: "icons/stopwatch.svg",
    html: `<i class="font-icon la la-star"></i>`,
...
Webforge.Components.add("elements/separator", {
    nodes: [".counter"],
    name: "Separator",
...
Webforge.Components.add("elements/Image box", {
    nodes: [".counter"],
    name: "Image Box",
    image: "icons/stopwatch.svg",
    html: `<i class="font-icon la la-star"></i>`,
...
Webforge.Components.add("elements/Icon box", {
    nodes: [".counter"],
    name: "Image Box",
    image: "icons/stopwatch.svg",
    html: `<i class="font-icon la la-star"></i>`,
...
Webforge.Components.add("elements/animated-headline", {
    nodes: [".counter"],
...
Webforge.Components.add("elements/price-table", {
    nodes: [".counter"],
    name: "Price table",
...
Webforge.Components.add("elements/price-list", {
    nodes: [".counter"],
    name: "Price list",
    image: "icons/stopwatch.svg",
    html: `<i class="font-icon la la-star"></i>`,
...
Webforge.Components.add("elements/reviews", {
    nodes: [".counter"],
    name: "Reviews",
...
Webforge.Components.add("elements/code", {
    nodes: ["code"],
    name: "Code",
...
Webforge.Components.add("elements/image-compare", {
    nodes: [".counter"],
    name: "Image Compare",
...
Webforge.Components.add("elements/rating", {
    nodes: [".rating"],
    name: "Rating stars",
