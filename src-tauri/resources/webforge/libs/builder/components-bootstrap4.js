...
https://github.com/givanz/webforgejs
*/
...
Webforge.ComponentsGroup['Bootstrap 4'] =
...
//display
Webforge.Components.extend("_base", "_base", {
	 properties: [
     {
        key: "display_header",
        inputtype: SectionInput,
...
Webforge.Components.extend("_base", "html/container", {
...
Webforge.Components.extend("_base", "html/heading", {
...
Webforge.Components.extend("_base", "html/link", {
    nodes: ["a"],
    name: "Link",
...
Webforge.Components.extend("_base", "html/image", {
    nodes: ["img"],
    name: "Image",
    html: '<img src="' +  Webforge.baseUrl + 'icons/image.svg" height="128" width="128">',
    /*
...
Webforge.Components.add("html/hr", {
    image: "icons/hr.svg",
    nodes: ["hr"],
    name: "Horizontal Rule",
    html: "<hr>"
});
Webforge.Components.extend("_base", "html/label", {
    name: "Label",
    nodes: ["label"],
...
Webforge.Components.extend("_base", "html/button", {
...
Webforge.Components.extend("_base", "html/buttongroup", {
    classes: ["btn-group"],
    name: "Button Group",
...
Webforge.Components.extend("_base", "html/buttontoolbar", {
    classes: ["btn-toolbar"],
    name: "Button Toolbar",
...
Webforge.Components.extend("_base","html/alert", {
    classes: ["alert"],
    name: "Alert",
...
Webforge.Components.extend("_base", "html/badge", {
    classes: ["badge"],
...
Webforge.Components.extend("_base", "html/card", {
    classes: ["card"],
...
Webforge.Components.extend("_base", "html/listgroup", {
    name: "List Group",
    image: "icons/list_group.svg",
    classes: ["list-group"],
    html: '<ul class="list-group">\n  <li class="list-group-item">\n    <span class="badge">14</span>\n    Cras justo odio\n  </li>\n  <li class="list-group-item">\n    <span class="badge">2</span>\n    Dapibus ac facilisis in\n  </li>\n  <li class="list-group-item">\n    <span class="badge">1</span>\n    Morbi leo risus\n  </li>\n</ul>'
});
Webforge.Components.extend("_base", "html/listitem", {
    name: "List Item",
    classes: ["list-group-item"],
    html: '<li class="list-group-item"><span class="badge">14</span> Cras justo odio</li>'
});
Webforge.Components.extend("_base", "html/breadcrumbs", {
    classes: ["breadcrumb"],
    name: "Breadcrumbs",
...
Webforge.Components.extend("_base", "html/breadcrumbitem", {
...
Webforge.Components.extend("_base", "html/pagination", {
    classes: ["pagination"],
    name: "Pagination",
...
Webforge.Components.extend("_base", "html/pageitem", {
	classes: ["page-item"],
...
Webforge.Components.extend("_base", "html/progress", {
    classes: ["progress"],
    name: "Progress Bar",
...
Webforge.Components.extend("_base", "html/jumbotron", {
    classes: ["jumbotron"],
...
Webforge.Components.extend("_base", "html/navbar", {
    classes: ["navbar"],
...
Webforge.Components.extend("_base", "html/form", {
    nodes: ["form"],
...
Webforge.Components.extend("_base", "html/textinput", {
    name: "Input",
	nodes: ["input"],
...
Webforge.Components.extend("_base", "html/selectinput", {
	nodes: ["select"],
    name: "Select Input",
		...
		$(node).find('option').each(function() {
			...
			properties.push({
				...
				onChange: function(node, value, input) {
					...
					{
						option.remove();
						Webforge.Components.render("html/selectinput");
						return node;
					}
...
Webforge.Components.extend("_base", "html/textareainput", {
    name: "Text Area",
    image: "icons/text_area.svg",
    html: '<div class="mb-3"><label>Your response:</label><textarea class="form-control"></textarea></div>'
});
Webforge.Components.extend("_base", "html/radiobutton", {
    name: "Radio Button",
...
Webforge.Components.extend("_base", "html/checkbox", {
    name: "Checkbox",
...
Webforge.Components.extend("_base", "html/fileinput", {
    name: "Input group",
...
Webforge.Components.extend("_base", "html/table", {
    nodes: ["table"],
    classes: ["table"],
...
Webforge.Components.extend("_base", "html/tablerow", {
    nodes: ["tr"],
    name: "Table Row",
...
Webforge.Components.extend("_base", "html/tablecell", {
    nodes: ["td"],
    name: "Table Cell",
    html: "<td>Cell</td>"
});
Webforge.Components.extend("_base", "html/tableheadercell", {
    nodes: ["th"],
    name: "Table Header Cell",
    html: "<th>Head</th>"
});
Webforge.Components.extend("_base", "html/tablehead", {
    nodes: ["thead"],
    name: "Table Head",
...
Webforge.Components.extend("_base", "html/tablebody", {
    nodes: ["tbody"],
    name: "Table Body",
    html: "<tbody><tr><td>Cell 1</td><td>Cell 2</td><td>Cell 3</td></tr></tbody>"
});

Webforge.Components.add("html/gridcolumn", {
    name: "Grid Column",
...
Webforge.Components.add("html/gridrow", {
    name: "Grid Row",
    image: "icons/grid_row.svg",
    classes: ["row"],
		...
		$(node).find('[class*="col-"]').each(function() {
			...
			properties.push({
				...
				onChange: function(node, value, input) {
					...
					{
						column.remove();
						Webforge.Components.render("html/gridrow");
						return node;
					}
...
Webforge.Components.extend("_base", "html/paragraph", {
    nodes: ["p"],
    name: "Paragraph",
...
Webforge.Components.extend("_base", "html/video", {
    nodes: ["video"],
    name: "Video",
    html: '<video width="320" height="240" playsinline loop autoplay><source src="../../media/sample.webm"><video>',
    dragHtml: '<img  width="320" height="240" src="' + Webforge.baseUrl + 'icons/video.svg">',
