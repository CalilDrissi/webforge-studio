...
Webforge.ComponentsGroup['Widgets'] = ["widgets/googlemaps", "widgets/embed-video", "widgets/chartjs", "widgets/lottie",/* "widgets/facebookpage", */"widgets/paypal", /*"widgets/instagram",*/ "widgets/twitter", "widgets/openstreetmap"/*, "widgets/facebookcomments"*/];

Webforge.Components.extend("_base", "widgets/googlemaps", {
    name: "Google Maps",
    attributes: ["data-component-maps"],
    image: "icons/map.svg",
    dragHtml: '<img src="' + Webforge.baseUrl + 'icons/maps.png">',
...
Webforge.Components.extend("_base", "widgets/openstreetmap", {
...
Webforge.Components.extend("_base", "widgets/embed-video", {
    name: "Embed Video",
    attributes: ["data-component-video"],
    image: "icons/youtube.svg",
    dragHtml: '<img src="' + Webforge.baseUrl + 'icons/youtube.svg" width="100" height="100">', //use image for drag and swap with iframe on drop for drag performance
...
Webforge.Components.extend("_base", "widgets/facebookcomments", {
    name: "Facebook Comments",
    attributes: ["data-component-facebookcomments"],
    image: "icons/facebook.svg",
    dragHtml: '<img src="' + Webforge.baseUrl + 'icons/facebook.svg">',
...
/*
Webforge.Components.extend("_base", "widgets/instagram", {
    name: "Instagram",
    attributes: ["data-component-instagram"],
    image: "icons/instagram.svg",
    drophtml: '<img src="' + Webforge.baseUrl + 'icons/instagram.png">',
...
*/
Webforge.Components.extend("_base", "widgets/twitter", {
    name: "Twitter",
    attributes: ["data-component-twitter"],
    image: "icons/twitter.svg",
    dragHtml: '<img src="' + Webforge.baseUrl + 'icons/twitter.svg">',
...
Webforge.Components.extend("_base", "widgets/paypal", {
    name: "Paypal",
...
\
				...
				<input type="hidden" name="item_name" value="Webforge">\
...
Webforge.Components.extend("_base", "widgets/facebookpage", {
    name: "Facebook Page Plugin",
    attributes: ["data-component-facebookpage"],
    image: "icons/facebook.svg",
    dropHtml: '<img src="' + Webforge.baseUrl + 'icons/facebook.png">',
...
Webforge.Components.extend("_base", "widgets/chartjs", {
    name: "Chart.js",
    attributes: ["data-component-chartjs"],
    image: "icons/chart.svg",
	dragHtml: '<img src="' + Webforge.baseUrl + 'icons/chart.svg">',
...
function lottieAfterDrop(node) {
	...
	if (!body.querySelector("#lottie-js")) {
		...
		lib.addEventListener('load', function() {		
			Webforge.Builder.iframe.contentWindow.initLottie();
		});
	} else {
		Webforge.Builder.iframe.contentWindow.initLottie(true);
	}
	
	return node;
};

Webforge.Components.add("widgets/lottie", {
    name: "Lottie",
