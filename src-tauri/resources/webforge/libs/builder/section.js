...
function sectionSeparatorProperties(name, title) {
	return [{
		...
		data: {
			url: Webforge.baseUrl + "../../resources/svg/separators/{value}/index.html",
			clickElement:"li",
			insertElement:"svg",
			elements: 'Loading ...',
			options: [{
...
//Webforge.Components.add("elements/section", {
Webforge.Components.extend("_base", "elements/section", {
    nodes: ["section"],
    name: "Section",
...
//Webforge.Components.add("elements/header", {
Webforge.Components.extend("_base", "elements/header", {
    nodes: ["header"],
    name: "Header",
    image: "icons/section.svg",
    html: `<header>
...
//Webforge.Components.add("elements/footer", {
Webforge.Components.extend("_base", "elements/footer", {
    nodes: ["footer"],
    name: "Footer",
    image: "icons/section.svg",
    html: `<footer>
