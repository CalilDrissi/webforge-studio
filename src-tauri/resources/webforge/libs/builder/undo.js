	...
	*/	
	addMutation : function(mutation) {	
		...
		*/
		...
		const event = new CustomEvent("webforge.undo.add", {detail: mutation});
		Webforge.Builder.frameBody.dispatchEvent(event);
	 },
	...
	restore : function(mutation, undo) {	
		...
		switch (mutation.type) {
			...
			case 'characterData':
			  ...
			  break;
			case 'style':
			  window.FrameDocument.getElementById("webforge-styles").textContent = ( undo ? mutation.oldValue : mutation.newValue );
			  break;
			case 'attributes':
		...
		const event = new CustomEvent("webforge.undo.restore", {detail: mutation});
		Webforge.Builder.frameBody.dispatchEvent(event);
	 },
