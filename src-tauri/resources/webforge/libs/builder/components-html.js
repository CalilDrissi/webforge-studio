...
Webforge.Components.extend("_base", "html/image", {
    nodes: ["img"],
    name: "Image",
    html: '<img src="' +  Webforge.baseUrl + 'icons/image.svg" width="200" class="img-fluid align-center">',
...
Webforge.Components.extend("_base", "html/hr", {
    image: "icons/hr.svg",
    nodes: ["hr"],
...
Webforge.Components.extend("_base", "html/blockquote", {
    nodes: ["blockquote"],
    name: "Blockquote",
...
Webforge.Components.extend("_base", "html/list-item", {
    nodes: ["li"],
    name: "List item",
...
Webforge.Components.extend("_base", "html/list", {
    nodes: ["ul", "ol"],
    name: "List",
	image: "icons/list.svg",
	html: `<ul>
		...
		onChange: function(node, value, input, component, event) {
			...
			if (event.action) {
				if (event.action == "add") {
					...
					Webforge.Components.render("html/list");
				}
...
Webforge.Components.extend("_base", "html/preformatted", {
    nodes: ["pre"],
    name: "Preformatted",
	image: "icons/paragraph.svg",
...
Webforge.Components.extend("_base", "html/tablefooter", {
    nodes: ["tfooter"],
    image: "icons/table.svg",
    name: "Table Footer",
...
Webforge.Components.extend("_base", "html/audio", {
    nodes: ["audio"],
...
Webforge.Components.extend("_base", "html/pdf", {
...
Webforge.Components.extend("_base", "html/embed", {
...
Webforge.Components.extend("_base", "html/html", {
    nodes: ["html"],
    name: "Html Page",
...
Webforge.Components.extend("_base", "html/iframe", {
	attributes: ["data-component-iframe"],
    name: "Iframe",
    image: "icons/file.svg",
    html: '<div data-component-iframe><iframe src="" width="320" height="240"></iframe></div>',
	properties: [{
        name: "Src",
        key: "src",
        htmlAttr: "src",
